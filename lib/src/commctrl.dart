...
const MESSAGE TCM_GETCURSEL          = MESSAGE(0x130B, 'TCM_GETCURSEL');
const MESSAGE TCM_SETCURSEL          = MESSAGE(0x130C, 'TCM_SETCURSEL');

const MESSAGE TCM_ADJUSTRECT          = MESSAGE(0x1328, 'TCM_ADJUSTRECT');
